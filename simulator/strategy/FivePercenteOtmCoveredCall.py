...
class FivePercenteOtmCoveredCall(CoveredCallStrategy):
    DIAS_VENCIMENTO_INI = 40
    DIAS_VENCIMENTO_FIM = 45

    def get_data_ini_limit(self, data_pregao: date) -> date:
        return data_pregao + timedelta(days=FivePercenteOtmCoveredCall.DIAS_VENCIMENTO_INI)

    def get_data_fim_limit(self, data_pregao: date) -> date:
        return data_pregao + timedelta(days=FivePercenteOtmCoveredCall.DIAS_VENCIMENTO_FIM)
